...
class Faculty(unittest.TestCase):
    ...
    def test_contactus(self):
        ...
        sleep(1)
        self.driver.find_element(By.CSS_SELECTOR, "input#name.form-conrol").click()
        sleep(1)
        self.driver.find_element(By.CSS_SELECTOR, "input#name.form-conrol").send_keys("Parin Mistry")
